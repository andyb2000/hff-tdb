		...
		if (!empty($row)) {
			...
			foreach ($row as $row_key=>$row_value) {
				if ($row_value["id"] == $curr_toy) {
					echo "<tr style='background-color:red' onclick='Javascript:alert($row_key);window.parent.forms[\"loanrequest\"].in_equipmentid.value=\"$row_key\";window.parent.SqueezeBox.close();'>";
				} else {
					echo "<tr onclick='Javascript:alert($row_key);window.parent.forms[\"loanrequest\"].in_equipmentid.value=\"$row_key\";window.parent.SqueezeBox.close();'>";
				};
