	...
	case "1":
		...
		if($tab == "loan") {
			...
			?>
							...
							<a href="<?=JURI::root()?>/administrator/index.php?option=com_users&task=user.edit&id=<?=$row["joomla_userid"]?>" class="modal" rel="{handler: 'iframe', size: {x: 500, y: 400}}">Toy selector</a>
							</td>
							</tr>
							<tr>
